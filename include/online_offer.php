...
<div class="wrapp_offer_online">
    ...
    <div class="wr_off_inner">
        ...
        <div class="offer_body">
            <form method="post" action="" id="offer_online_form">
                <div class="col-md-6">
                    <p class="lable">Вы являетесь</p>
                    <select name="offer_type" id="type_of_client">
                ...
                <div class="col-md-6">
                    ...
                    <select name="offer_delivery" id="delivery">
                ...
                <div class="col-md-6">
                    <p class="lable">ФИО</p>
                    <input type="text" name="client_name" id="name_data">
                </div>
                <div class="col-md-6">
                    <p class="lable">Адрес доставки</p>
                    <input type="text" name="adress" id="adress_data">
                </div>
                <div class="col-md-12">
                    <p class="lable">Контактные данные (электронная почта или телефон)</p>
                    <input type="text" name="contacts" id="contacts_data">
                </div>
                <div class="col-md-12">
                    <p class="lable">Интересующая Вас продукция и количество</p>
                    <textarea name="offer_message" id="field_txt" cols="30" rows="10"></textarea>
